import 'package:demo2/MGB/classesMGB/1.Monday/classMGB(mon%208%20to%209%20am).dart';
...
class TimingMGB extends StatefulWidget {
  const TimingMGB({Key? key});

  @override
  _TimingMGBState createState() => _TimingMGBState();
}

class _TimingMGBState extends State<TimingMGB> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classMGBmon8to9am(),
                          ),
                        );
