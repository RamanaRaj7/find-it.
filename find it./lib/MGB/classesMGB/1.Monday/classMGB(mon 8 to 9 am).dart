...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Scaffold(
        body: classMGBmon8to9am(),
      ),
    );
  }
}

class classMGBmon8to9am extends StatelessWidget {
  const classMGBmon8to9am({super.key});
      ...
      body: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Monday MGB (8 to 9 am)", // Replace with your desired text
              style: TextStyle(
                fontSize: 24.0,
