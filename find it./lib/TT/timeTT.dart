...
import 'classesTT/1.Monday/classTT(mon 8 to 9 am).dart';
...
class TimingTT extends StatefulWidget {
  const TimingTT({Key? key});

  @override
  _TimingTTState createState() => _TimingTTState();
}

class _TimingTTState extends State<TimingTT> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classTTmon8to9am(),
                          ),
                        );
