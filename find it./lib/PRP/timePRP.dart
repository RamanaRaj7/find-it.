import 'package:demo2/PRP/classesPRP/1.Monday/classPRP(mon%208%20to%209%20am).dart';
...
class TimingPRP extends StatefulWidget {
  const TimingPRP({Key? key});

  @override
  _TimingPRPState createState() => _TimingPRPState();
}

class _TimingPRPState extends State<TimingPRP> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classPRPmon8to9am(),
                          ),
                        );
