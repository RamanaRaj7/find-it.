...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Scaffold(
        body: classGDNmon8to9am(),
      ),
    );
  }
}

class classGDNmon8to9am extends StatelessWidget {
  const classGDNmon8to9am({super.key});
      ...
      body: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Monday GDN (8 to 9 am)", // Replace with your desired text
              style: TextStyle(
                fontSize: 24.0,
