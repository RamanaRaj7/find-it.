import 'package:demo2/GDN/classesGDN/1.Monday/classGDN(mon%208%20to%209%20am).dart';
...
class TimingGDN extends StatefulWidget {
  const TimingGDN({Key? key});

  @override
  _TimingGDNState createState() => _TimingGDNState();
}

class _TimingGDNState extends State<TimingGDN> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classGDNmon8to9am(),
                          ),
                        );
