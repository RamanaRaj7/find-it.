import 'package:demo2/MB/classesMB/1.Monday/classMB(mon%208%20to%209%20am).dart';
...
class TimingMB extends StatefulWidget {
  const TimingMB({Key? key});

  @override
  _TimingMBState createState() => _TimingMBState();
}

class _TimingMBState extends State<TimingMB> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classMBmon8to9am(),
                          ),
                        );
