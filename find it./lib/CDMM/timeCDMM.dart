import 'package:demo2/CDMM/classesCDMM/1.Monday/classCDMM(mon%208%20to%209%20am).dart';
...
class TimingCDMM extends StatefulWidget {
  const TimingCDMM({Key? key});

  @override
  _TimingCDMMState createState() => _TimingCDMMState();
}

class _TimingCDMMState extends State<TimingCDMM> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classCDMMmon8to9am(),
                          ),
                        );
