import 'package:demo2/SJT/classesSJT/1.Monday/classSJT(mon%208%20to%209%20am).dart';
...
class TimingSJT extends StatefulWidget {
  const TimingSJT({Key? key});

  @override
  _TimingSJTState createState() => _TimingSJTState();
}

class _TimingSJTState extends State<TimingSJT> {
                    ...
                    onTap: () {
                      ...
                      if (buttonName == "8 to 9 am" &&
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const classSJTmon8to9am(),
                          ),
                        );
