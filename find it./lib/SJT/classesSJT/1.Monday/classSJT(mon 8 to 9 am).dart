...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Scaffold(
        body: classSJTmon8to9am(),
      ),
    );
  }
}

class classSJTmon8to9am extends StatelessWidget {
  const classSJTmon8to9am({super.key});
      ...
      body: Column(
        children: [
          ...
          const Padding(
            ...
            child: Text(
              "Monday SJT (8 to 9 am)", // Replace with your desired text
              style: TextStyle(
                fontSize: 24.0,
